...
<body>
	...
	<main id="main">
		<div id="rida">
			<div class="footer-newsletter" id="newz">
				<div class="container">
					<div class="row justify-content-center">
						<div class="col-11">
							<h4>Notre recette d’une réalisation audiovisuelle efficace, est un univers mélange fait
								d’écoute, d’idées, de compréhension des enjeux et de savoir-faire technique.</h4>
						</div>
					</div>
				</div>
			</div>
